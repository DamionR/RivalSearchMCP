    ...
    async def analyze_content(
        ...
        try:
            ...
            if analysis_type == "sentiment":
                ...
                analysis_result["insights"]["technical_terms"] = list(technical_terms)[
                    :10
                ]
...
# from src.core.search import GoogleSearchScraper
            ...
            if research_results["key_findings"]:
                ...
                if include_analysis:
                    research_results["recommendations"].append(
                        "Use analyze_content tool for detailed insights"
                    )
            ...
            return {"success": False, "error": str(e), "research_plan": {}}
